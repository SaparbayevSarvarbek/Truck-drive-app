                ...
                child: Card(
                  ...
                  child: Theme(
                    ...
                    child: ExpansionTile(
                      ...
                      subtitle: Text(
                        'From: ${product?.fromLocationName ?? "Номаълум"} → To: ${product?.toLocationName ?? "Номаълум"}',
                      ...
                      children: [
                        ...
                        _infoTile(iconColor, Icons.monetization_on, 'Умумий нарх',
                            '${history.price} сўм'),
                        _infoTile(
                            iconColor,
                        ...
                        ...history.products.map((p) => ListTile(
                          ...
                          subtitle: Text(
                            'From: ${p.fromLocationName ?? "Номаълум"} → To: ${p.toLocationName ?? "Номаълум"}',
